...
| --- | --- | --- |
| Pipeline | `book-analysis-v10` | Малые scan-фрагменты, resolver, барьеры и семантический контроль полноты |
| Scan prompt и extractor | `book-scan-v5` | Извлечение, фильтрация метаданных и проверка участников отношений |
...
## 6. Доказательная валидация `book-scan-v5`
...
`book-scan-v5` сохраняет доказанные элементы и отбрасывает только проблемные.
