...
| Gateway staging | `services/narra-gateway` | Docker Compose in `/srv/narra-stagging` on i167 |
...
The replacement staging Gateway runs on i167 from `/srv/narra-stagging` and is
