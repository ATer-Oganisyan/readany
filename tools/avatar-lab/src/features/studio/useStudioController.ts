...
import { renderAvatarByStyle } from '@/features/rendering/narraFaceGeometry'
...
export function useStudioController() {
  ...
  const [mode, setMode] = useState<Mode>('expressions')
  ...
  const paintPose = (
    ...
    const geometry = renderAvatarByStyle(
      ...
      avatar?.renderStyle ?? initialAvatar.renderStyle,
      {
