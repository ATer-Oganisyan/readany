...
test('object storage writes media for namespaced v3 character keys', async () => {
  let command
  const storage = createBookObjectStorage({
  ...
  const objectKey = [
    'generated/catalog/11111111-1111-4111-8111-111111111111/characters',
    'character:anna/character-bundle-v3/primary-portrait.png'
  ].join('/')
  await storage.putBytes({ objectKey, bytes: Buffer.from('portrait'), mimeType: 'image/png' })
