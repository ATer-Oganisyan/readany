export const BOOK_ANALYSIS_PIPELINE_VERSION = 'book-analysis-v13'
...
export const BOOK_ANALYSIS_PROMPT_VERSION = 'book-scan-v8'
export const BOOK_ANALYSIS_EXTRACTOR_VERSION = 'book-scan-v8'
