...
export const ART_STYLE =
  "фанарт-иллюстрация в полуреалистичной аниме-стилистике (semi-realistic anime), цифровой " +
  "рисунок с чистыми линиями и мягкой светотенью, выразительные характерные персонажи крупным " +
  "планом, НЕ фотореализм, тёплый рассеянный свет, гармоничная палитра, единая серия работ " +
  "одного художника; строго без текста, без букв, без цифр, без надписей, без логотипов и " +
  "водяных знаков";
